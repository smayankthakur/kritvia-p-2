  ...
  ({ 
    ...
    const variants = {
      ...
      secondary: `
        ...
        hover:bg-secondary-400 focus:ring-secondary-500
        shadow-lg shadow-secondary-500/20 hover:shadow-secondary-500/30
      `,
      outline: `
        border-2 border-primary-500 text-primary-400
        hover:bg-primary-500/10 hover:border-primary-400 focus:ring-primary-500
        bg-transparent
      `,
      ghost: `
      ...
      `,
      link: `
        text-primary-400 hover:text-primary-300 hover:underline
        p-0 bg-transparent focus:ring-primary-500
      `,
      dark: `
