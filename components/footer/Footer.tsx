...
export function Footer() {
  ...
  return (
    <footer className="bg-neutral-950 border-t border-neutral-800 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-sky-500 to-purple-500 opacity-50" />
      <div className="absolute -top-48 -right-48 w-96 h-96 bg-sky-500/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-7 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="flex items-center space-x-2 mb-4 group">
                ...
                <span className="text-xl font-bold bg-gradient-to-r from-sky-400 to-purple-400 bg-clip-text text-transparent">Kritvia</span>
              </Link>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-400 hover:text-white hover:border-sky-500/50 hover:shadow-[0_0_15px_rgba(14,165,233,0.3)] transition-all duration-300"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-400 hover:text-white hover:border-purple-500/50 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)] transition-all duration-300"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
