...
import { SalesPrompt } from '../prompts/sales.prompt';
...
export class SalesAgent {
  ...
  constructor() {
    ...
    this.prompt = new SalesPrompt();
  }

  async analyze(input: z.infer<typeof SalesAgentInputSchema>) {
